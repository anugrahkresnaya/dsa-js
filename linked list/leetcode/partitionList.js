...
class LinkedList {
  ...
  partitionList(x) {
    ...
    while (current !== null) {
      ...
      // console.log('current after one step', current)
      // console.log('prev1 luar', prev1)
      // console.log('prev2 luar', prev2 )
    }
    prev2.next = null
    console.log('prev2 after nulling next', prev2)
    prev1.next = dummy2.next
    console.log('prev1 after set next to next of numm2', prev1)
