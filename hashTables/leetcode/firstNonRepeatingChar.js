...
function firstNonRepeatingChar(char) {
  ...
  for(let i of char) {
    newChar.set(i, (newChar.get(i) || 0) + 1)
  }
  // console.log('newChar', Array.from(newChar))

  for(let [char, count] of newChar) {
    if(count === 1) {
      nonRepeatChars.push(char)
    }
  }

  // console.log('non', nonRepeatChars)
  // let res = null
  // for(let i of nonRepeatChars) {
  //   // console.log('i again', i)
  //   if(nonRepeatChars.indexOf(i) === 1) {
  //     res = i
  //   }
  // }
  // return res
